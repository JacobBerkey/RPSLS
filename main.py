...
# * COMPLETE (5 points): As a developer, I want to make at least 10 commits with descriptive messages.
...
# * COMPLETE (10 points): As a player, I want the correct player to win a given round based on the choices* made by
# each player.

# * COMPLETE (10 points): As a player, I want the game of RPSLS to be at minimum a ‘best of three’ to decide a
# winner.

# * COMPLETE (10 points): As a player, I want the option of a single player (human vs AI) or a multiplayer (human vs
# human) game.
